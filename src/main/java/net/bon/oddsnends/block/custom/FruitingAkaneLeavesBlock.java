...
public class FruitingAkaneLeavesBlock extends LeavesBlock {
    public FruitingAkaneLeavesBlock(Settings settings) {
        super(settings);
    }
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        BlockState blockState = OddBlocks.AKANE_LEAVES.getDefaultState();
