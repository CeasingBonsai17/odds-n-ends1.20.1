package net.bon.oddsnends.world.gen.trunk;
...
public class LargeAkaneTrunkPlacer extends TrunkPlacer {
    public static final Codec<LargeAkaneTrunkPlacer> CODEC = RecordCodecBuilder.create((instance) -> {
        return fillTrunkPlacerFields(instance).apply(instance, net.bon.oddsnends.world.gen.trunk.LargeAkaneTrunkPlacer::new);
    });
    ...
    public LargeAkaneTrunkPlacer(int i, int j, int k) {
        super(i, j, k);
    }
    ...
    public List<FoliagePlacer.TreeNode> generate(TestableWorld world, BiConsumer<BlockPos, BlockState> replacer, Random random, int height, BlockPos startPos, TreeFeatureConfig config) {
        ...
        int n = j - 5;
        List<net.bon.oddsnends.world.gen.trunk.LargeAkaneTrunkPlacer.BranchPosition> list = Lists.newArrayList();
        list.add(new net.bon.oddsnends.world.gen.trunk.LargeAkaneTrunkPlacer.BranchPosition(startPos.up(n), m));
                ...
                for(int o = 0; o < l; ++o) {
                    ...
                    if (this.makeOrCheckBranch(world, replacer, random, blockPos, blockPos2, false, config)) {
                        ...
                        if (this.makeOrCheckBranch(world, replacer, random, blockPos3, blockPos, false, config)) {
                            list.add(new net.bon.oddsnends.world.gen.trunk.LargeAkaneTrunkPlacer.BranchPosition(blockPos, blockPos3.getY()));
                        }
                    }
                }
            }
        ...
        while(var37.hasNext()) {
            net.bon.oddsnends.world.gen.trunk.LargeAkaneTrunkPlacer.BranchPosition branchPosition = (net.bon.oddsnends.world.gen.trunk.LargeAkaneTrunkPlacer.BranchPosition)var37.next();
    ...
    private void makeBranches(TestableWorld world, BiConsumer<BlockPos, BlockState> replacer, Random random, int treeHeight, BlockPos startPos, List<net.bon.oddsnends.world.gen.trunk.LargeAkaneTrunkPlacer.BranchPosition> branchPositions, TreeFeatureConfig config) {
        Iterator var8 = branchPositions.iterator();

        while(var8.hasNext()) {
            net.bon.oddsnends.world.gen.trunk.LargeAkaneTrunkPlacer.BranchPosition branchPosition = (net.bon.oddsnends.world.gen.trunk.LargeAkaneTrunkPlacer.BranchPosition)var8.next();
